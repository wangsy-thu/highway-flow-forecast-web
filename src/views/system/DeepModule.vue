<template>
  <div>
    ...
    <!-- 搜索筛选过滤 -->
    <el-form :inline="true" :model="formInline" class="module-search">
      <el-form-item label="搜索">
        <el-input size="small" v-model="formInline.name" placeholder="输入模型名称"></el-input>
      </el-form-item>
      <el-form-item>
      ...
      <el-form label-width="100px" ref="editForm" :model="editForm">
        ...
        <el-form-item label="上传算法文件">
          <el-upload
            ...
            <div slot="tip" class="el-upload__tip">只能上传模型文件文件，且不超过2MB</div>
          </el-upload>
        </el-form-item>
      </el-form>
      ...
      let res = {
        ...
        data: [
          ...
          },
          {
            ...
            desc: "时间序列分析",
            useState: "启用",
            inputType: "Tensor[N, T, F]",
            outputType: "Tensor[N, T]"
          }
        ]
      }
      this.loading = false
